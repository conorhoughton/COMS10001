...
It is perhaps worth noting that Dijkstra's algorithm does not use the
identity of the target node, starting with the starting node it
spreads knowlege of the shortest path outwards through the graph and
